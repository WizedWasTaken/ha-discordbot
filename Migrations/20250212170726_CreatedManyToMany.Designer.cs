...
namespace BotTemplate.Migrations
{
    ...
    [Migration("20250212170726_CreatedManyToMany")]
    partial class CreatedManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Absences", b =>
                {
            ...
            modelBuilder.Entity("Attendances", b =>
                {
                    b.Property<int>("AttendedUserId")
                        .HasColumnType("int");

                    b.Property<int>("EventId")
                        .HasColumnType("int");

                    b.HasKey("AttendedUserId", "EventId");
            ...
            modelBuilder.Entity("Absences", b =>
                {
                    b.HasOne("BotTemplate.BotCore.Entities.User", null)
                        .WithMany()
